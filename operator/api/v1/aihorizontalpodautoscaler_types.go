...
// AIHorizontalPodAutoscaler is the Schema for the aihorizontalpodautoscalers API
type AIHorizontalPodAutoscaler struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   AIHorizontalPodAutoscalerSpec   `json:"spec,omitempty"`
	Status AIHorizontalPodAutoscalerStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AIHorizontalPodAutoscalerList contains a list of AIHorizontalPodAutoscaler
type AIHorizontalPodAutoscalerList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AIHorizontalPodAutoscaler `json:"items"`
}

func init() {
	SchemeBuilder.Register(&AIHorizontalPodAutoscaler{}, &AIHorizontalPodAutoscalerList{})
}
